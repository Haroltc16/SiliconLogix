...
class UsuarioManager(BaseUserManager):
    def create_user(self, dni, nombre, apellidos, correo, telefono, edad, password=None):
        if not dni:
    ...
    def create_superuser(self, dni, nombre, apellidos, correo, telefono, edad, password=None):
...
class Usuario(AbstractBaseUser, PermissionsMixin):
    ...
    USERNAME_FIELD = 'dni'
    REQUIRED_FIELDS = ['nombre', 'apellidos', 'correo', 'telefono', 'edad']
