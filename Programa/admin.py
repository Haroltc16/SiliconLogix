...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = Usuario
        fields = ('dni', 'nombre', 'apellidos', 'correo', 'telefono', 'edad', 'foto', 'is_active', 'is_staff', 'is_admin')
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Usuario
        fields = ('dni', 'nombre', 'apellidos', 'correo', 'telefono', 'edad', 'foto', 'password', 'is_active', 'is_staff', 'is_admin', 'groups')
...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        (None, {'fields': ('dni', 'nombre', 'apellidos', 'correo', 'telefono', 'edad', 'foto', 'password', 'is_active', 'is_staff', 'is_admin', 'groups')}),
    )
    add_fieldsets = (
        (None, {'fields': ('dni', 'nombre', 'apellidos', 'correo', 'telefono','edad', 'foto', 'password1', 'password2', 'is_active', 'is_staff', 'is_admin', 'groups')}),
    )

    # Especifica los campos para la visualización en el listado
    list_display = ('dni', 'nombre', 'apellidos', 'correo', 'telefono','edad', 'foto', 'is_active', 'is_staff', 'is_admin')
    ordering = ('dni',)
